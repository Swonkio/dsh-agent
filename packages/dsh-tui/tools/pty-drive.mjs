 ...
 * `dsh --profile tui` on a real pty, waits for the prompts it expects, sends
...
const require = createRequire('/home/agent/dsh-tui/node_modules/')
...
const child = pty.spawn(process.execPath, [
  '/home/agent/deepseek-harness/apps/cli/lib/bin.js', '--profile', 'tui',
