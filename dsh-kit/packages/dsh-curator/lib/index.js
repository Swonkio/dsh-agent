...
import { loadUsage, noteOutcome, scanMemory, archiveSkill, restoreSkill, setPinned, markRun } from './store.js'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args) {
      if (args.action === 'report') {
        ...
        const plan = curationPlan({ skills: usage, staleMemories, conflicts }, policy)
        await markRun(home)
